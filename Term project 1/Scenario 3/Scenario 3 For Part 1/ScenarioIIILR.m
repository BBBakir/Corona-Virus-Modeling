...
figure(2)
plot(t_it,avtt_nni,"c",'LineWidth',2)
...
figure(3)
plot(t_it,avtt_ni,"c",'LineWidth',2)
...
figure(4)
plot(t_it,avtt_nnh,"c",'LineWidth',2)
...
figure(5)
plot(t_it,avtt_nh,"c",'LineWidth',2)
...
figure(6)
plot(t_it,avtt_nnd,'c','LineWidth',2)
...
figure(7)
plot(t_it,avtt_nd,'c','LineWidth',2)
...
figure(8)
plot(it_v,n_aatv,"c",'LineWidth',2)
...
figure(9)
plot(it_v,n_aattv,'c','LineWidth',2)
...
figure(10)
plot(t_it,n_aativ,'c','LineWidth',2)
...
figure(11)
plot(t_it,n_nnndd,'c','LineWidth',2)
