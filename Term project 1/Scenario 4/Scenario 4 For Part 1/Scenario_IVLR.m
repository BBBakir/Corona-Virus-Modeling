...
figure(2)
plot(t_it,avtt_nni,"k",'LineWidth',2)
title('Number of newly infected people in each iteration')
ylabel('Number of newly infected people')
xlabel('Number of iterations')
legend("Scenerio 1","Scenerio 2","Scenerio 3","Scenerio 4")
xlim([0 175])
ylim([0 35])
hold on

figure(3)
plot(t_it,avtt_ni,"k",'LineWidth',2)
...
figure(4)
plot(t_it,avtt_nnh,"k",'LineWidth',2)
...
figure(5)
plot(t_it,avtt_nh,"k",'LineWidth',2)
...
figure(6)
plot(t_it,avtt_nnd,'k','LineWidth',2)
...
figure(7)
plot(t_it,avtt_nd,'k','LineWidth',2)
...
figure(8)
plot(it_v,n_aatv,"k",'LineWidth',2)
title('Number of vaccinated people in each iteration,')
ylabel('Number of vaccinated people')
xlabel('Number of iterations')
legend("Scenerio 2","Scenerio 3","Scenerio 4")
xlim([0 175])
ylim([0 120])
hold on

figure(9)
plot(it_v,n_aattv,'k','LineWidth',2)
...
figure(10)
plot(t_it,n_aativ,'k','LineWidth',2)
...
figure(11)
plot(t_it,n_nnndd,'k','LineWidth',2)
